...
urlpatterns = [
    ...
    url(r'^kststaff/success/', TemplateView.as_view(template_name='register/kststaff/success.html'), name='success'),
    ...
    url(r'^students/filter/$', TemplateView.as_view(template_name='register/kststaff/filter_external.html'),name="filter_external"),
    ...
    url(r'^book_vazhipad/$', Book_vazhipadView.as_view(), name= "book_vazhipad"),
    url(r'^kart/$', KartListView.as_view(), name='kart'),
]